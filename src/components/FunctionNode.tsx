...
const FunctionNode = (props: React.PropsWithChildren<FunctionNodeProps>) => {
    ...
    const title = props.function.namespace + typeName + ' :: ' + props.function.name + ' (' + props.function.functionType + ' - ' + props.function.getGrouping().name + ': ' + props.function.getSearch(props.search) + ')'
    return (
